...
def validate_numeric_column(df, column_name):
    ...
    if not df[column_name].dtype.kind in "iuf":
        raise HTTPException(
            status_code=400,
            detail=f"'{column_name}' must be numeric."
        )
...
def histogram(
    ...
    image = VisualizationService.histogram(
        df,
        column_name
    )
...
def bar_chart(
    ...
    image = VisualizationService.bar_chart(
        df,
        column_name
    )
...
def line_chart(
    ...
    image = VisualizationService.line_chart(
        df,
        x_column,
        y_column
    )
...
def scatter_plot(
    ...
    image = VisualizationService.scatter_plot(
        df,
        x_column,
        y_column
    )
...
def box_plot(
    ...
    image = VisualizationService.box_plot(
        df,
        column_name
    )
...
def pie_chart(
    ...
    image = VisualizationService.pie_chart(
        df,
        column_name
    )
